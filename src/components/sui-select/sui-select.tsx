...
export class SuiSelect {
  ...
  render() {
    return (
      <Host>
        <div>
          {/* <span data-selected={this.value} style={{ marginTop: `-${this.topPadding}`, display: this.isMultiple ? 'none' : 'flex', left: this.leftPadding, width: `calc(100% - ${this.leftPadding} - ${this.rightPadding} - ${this.isMultiple ? 0 : 0.75}em)` }}></span> */}
