...
import { r as randomString } from './utils.js';

const suiOverlayCss = ":host{display:none !important}";

const SuiOverlay$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return suiOverlayCss; }
}, [1, "sui-overlay", {
    "position": [1],
    "transitionTime": [1, "transition-time"],
    "close": [64],
    "open": [64]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["sui-overlay"];
  components.forEach(tagName => { switch (tagName) {
    case "sui-overlay":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, SuiOverlay$1);
      }
      break;
  } });
}

const SuiOverlay = SuiOverlay$1;
const defineCustomElement = defineCustomElement$1;

export { SuiOverlay, defineCustomElement };
