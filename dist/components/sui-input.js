...
import { r as randomString, d as dummyHandler, c as cloneEvents } from './utils.js';
...
const SuiInput$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return suiInputCss; }
}, [1, "sui-input", {
    "value": [520]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["sui-input"];
  components.forEach(tagName => { switch (tagName) {
    case "sui-input":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, SuiInput$1);
      }
      break;
  } });
}

const SuiInput = SuiInput$1;
const defineCustomElement = defineCustomElement$1;

export { SuiInput, defineCustomElement };
